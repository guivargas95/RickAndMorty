    ...
    return (
        <div className="bg-paleta-marrom bg-background-characters bg-cover bg-no-repeat md:h-screen">
            ...
            <div className="flex justify-center mb-10">
                <img className="w-48" src="/img/back.png" alt="" onClick={() => navigate(-1)} />
            </div>
            <section className="w-2/4 justify-center mr-auto ml-auto md:w-auto flex flex-col md:flex-row">
                <div className="flex flex-col text-center ms:w-full">
                ...
                <div className="bg-green-600 rounded-lg text-white text-center text-xl ms:w-full">
